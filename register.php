        ...
        <div class="card-body bg-light">
          ...
          <form action="config/proses_register.php" method="post">
            ...
            <div class="d-grid mt-2">
              <button class="btn btn-outline-primary text-dark" type="submit" name="kirim">Daftar</button>
            </div>
          </form>
          <hr>
          <p>Sudah punya akun? <a href="login.php" class="text-dark"> Login disini </a></p>
        </div>
      </div>
    </div>
  </div>
